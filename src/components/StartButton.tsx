export default function StartGameButton() {
  return (
    <div className="relative h-10 w-42">
      ...
      <button
        className="orbitron-bold relative w-full cursor-pointer h-full flex items-center justify-center border-2 bg-transparent font-normal text-xs uppercase tracking-wider text-yellow-400 transition-all duration-200 hover:px-8 overflow-hidden"
        style={{
          clipPath:
